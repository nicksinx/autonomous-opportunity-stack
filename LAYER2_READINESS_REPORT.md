...
Generated: 2026-05-04T09:07:45.831Z  |  Repo HEAD: 09072bbf4d2b  |  Verdict: **READY**
...
| `must.workflow.scoring_run_per_execution` | wf_score_and_cluster opens one scoring_runs row per execution | PASS | scoring_runs INSERT + RETURNING present; scoring_runs(7d)=31 |  |
| `must.workflow.outbox_events_in_scorer` | wf_score_and_cluster emits workflow_outbox events | PASS | SQL present; outbox(7d)={"opportunity_needs_review":680,"opportunity_scored":680} |  |
